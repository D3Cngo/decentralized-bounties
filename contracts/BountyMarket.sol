    ...
    Multicall
{
        ...
        onlyExistingListing(_listingId)
    {
        ...
        if (listing.pricePerToken > 0) {
            payoutOnClaim(listing, _quantity);
        }

        // Transfer tokens being bought to buyer.
        sendTokens(listing, _quantity);

        emit NewBounty(listing.assetContract, listing.seller, _listingId, buyer, _quantity, listing);
    }
    ...
    function payoutOnClaim(Listing memory listing, uint256 _quantity) internal {
